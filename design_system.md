...
### 9.7 공개·홈 부품 10 (v5 신설 · 4차 F-1 — 아홉 · **#10 은 F-2**)

`src/app/_screens/site/`. **공개 현관·로그인 홈 전용 계층**이고 콘솔·측정 부품과 섞지 않는다.

**열 부품에 공통으로 걸리는 한 줄** — **부품은 계산하지 않는다.** 현재 회차·잠금·완료·현재 경로가
