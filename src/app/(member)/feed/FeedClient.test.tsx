// 기수 전환이 **화면으로 보이는가** — 실기기 2차 지적(2026-08-27)의 회귀 잠금.
//
...
describe('기수 전환이 눈에 보인다', () => {
  ...
  it('**선택된 기수와 안 된 기수가 다르게 보인다** — 같으면 클릭이 먹었는지 알 수 없다', () => {
    const html = render(A.cohortId);
  ...
  it('**글이 0건이어도 빈 화면이 기수를 말한다** — 전환의 유일한 증거일 때가 있다', () => {
  ...
  it('기수가 하나면 칩도 이름도 붙이지 않는다 — 없는 선택을 암시하지 않는다', () => {
