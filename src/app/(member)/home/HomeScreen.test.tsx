...
describe('HomeScreen — 시안 B', () => {
  // **이 단언은 껍데기로 옮겼다**(U-2) — `MemberShell.test.tsx` 가 로고+햄버거를 잰다.
  //   여기서는 **화면이 더는 그리지 않는다**는 사실을 잰다(§12.3 규칙 1의 회귀 잠금).
  it('**화면이 상단바를 그리지 않는다** — 껍데기가 그린다', () => {
...
// ── 5차 T-5 · 겸직자에게 카드가 둘 선다 ─────────────────────────────────
describe('HomeScreen — 역할 카드 복수 (T-5)', () => {
