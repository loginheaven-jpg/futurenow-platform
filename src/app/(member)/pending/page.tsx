...
const COPY = {
  pending: {
    ...
    lead: '운영자가 자격 확인을 마치면 체크 이용이 열립니다.',
    step2: '보통 1~2일 안에 안내합니다.',
  },
  held: {
    title: '확인이 필요한 신청입니다',
    lead: '자격 확인을 위해 신청 내용을 검토하고 있습니다.',
    step2: '확인에 필요한 내용이 있다면 문의로 알려 주세요.',
  },
  expired: {
    title: '이용 기간이 지났습니다',
    lead: '이용 기간이 종료되어 새 체크는 열리지 않습니다. 이전 기록과 결과는 계속 확인할 수 있습니다.',
    step2: '갱신은 운영자 확인 후 진행됩니다.',
  },
} as const;
