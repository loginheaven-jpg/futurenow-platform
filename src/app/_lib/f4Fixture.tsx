...
import type { CohortHomeScreenProps } from '@/app/my/cohorts/[cohortId]/CohortHomeScreen';
import type { AssessmentsScreenProps } from '@/app/home/assessments/AssessmentsScreen';
import { HOME_FIXTURE } from '@/app/home/homeFixture';

const WHO = { name: '김서온', role: '참여자', cohort: '예봄 2기' };
const SHEET = { groups: HOME_FIXTURE.groups, chips: HOME_FIXTURE.chips };
