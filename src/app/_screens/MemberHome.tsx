// 멤버 홈 본문(프레젠테이션 — 부수효과 없음). 인사 + 1차 행동([코드로 세미나 참여]) + [내 차수].
// 참여자 팔레트·중립. danger/warning/care 의미색 0(§0.4). 셸 헤더·로그아웃은 /home 이 얹는다.
// [내 차수] → /my/cohorts (Step 1.2 에서 활성화됨).
...
export function MemberHome({ greetingName }: { greetingName: string }) {
  return (
    <div>
      ...
      {/* 내 차수 → /my/cohorts (활성). */}
      <a className="ui-btn ui-btn--ghost" href="/my/cohorts" style={{ ...cta, marginTop: 'var(--space-3)' }}>내 차수</a>
    </div>
  );
}
