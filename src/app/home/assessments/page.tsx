...
export default async function AssessmentsPage() {
  ...
  return (
    <AssessmentsScreen
      who={{ name: me.name?.trim() || '회원', role: '참여자', cohort: sheet.cohortName }}
      ...
      privacy={
        valueCohort ? (
          <><b>이 결과는 우리 기수 인도자와 함께 봅니다.</b> 코칭에 쓰이는 재료입니다. 정답이 없으니 편하게 쓰셔도 됩니다.</>
        ) : (
          <><b>이 결과는 나만 봅니다.</b> 정답이 없으니 편하게 쓰셔도 됩니다.</>
        )
      }
      groups={sheet.groups}
      chips={sheet.chips}
