...
export default function Home() {
  return (
    <main style={{ maxWidth: 430, margin: '0 auto', padding: 'var(--space-8) var(--space-4)' }}>
      ...
      <div style={divider} />
      <IntroBlock title="개요" body="청년이 자기 삶의 방향을 스스로 발견하도록 돕는 다주차 세미나입니다. 답을 주입하는 강의가 아니라, 스스로 묻고 발견하도록 설계된 구조입니다." />
      <IntroBlock title="효과" body="지금의 나를 직면하고, 되고 싶은 미래 자아를 구체적인 상으로 그리며, 그 사이를 잇는 행동을 자기 손으로 설계합니다." />
      <IntroBlock title="진행방식" body="짧은 사전 진단으로 시작합니다. 몇 주에 걸쳐 함께 모여 나누고, 세미나가 끝나면 다시 진단으로 변화를 확인합니다." />
