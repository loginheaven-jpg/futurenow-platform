...
export const CHECKIN_SESSION_1 = {
  ...
  cover: {
    ...
    // ADR-102 Phase 2 축1·축2 — 완충('잘 쓰려 하지 않으셔도')을 지우고 이 카드가 7주 안에서 어디 서는지 말한다.
    band: '오늘 꺼낸 것을, 흐려지기 전에 붙잡아 둡니다. 7주 기록의 첫 장입니다.',
  ...
  today: {
    ...
    pairText: {
      ...
      // ADR-102 — 어미만 교체(고르시면 됩니다 → 고르십시오). 앞 문장의 '~도 좋습니다'는 허락이 아니라
      //   **범위 예시**라 남긴다 — 무엇을 적어야 하는지 묻는 사람에게 답의 폭을 알려 주는 문장이다.
      help: '약점을 강점으로 바꾼 것도, 아픔을 갈망으로 바꾼 것도 좋습니다. 바꿔 쓰는 순간 가장 시원했던 하나만 고르십시오.',
  ...
  deepen: {
    ...
    fields: [
      ...
      // ADR-102 Phase 2 축1 — 말미의 허락만 명령형으로. 앞부분(분량 지시)은 이미 요구형이라 그대로 둔다.
      { key: 'letter_line', label: '과거의 나에게 편지를 써 보세요.', help: '만약 종이에 이미 썼다면 그 내용 중 가장 해 주고 싶었던 말 한 줄만 옮겨 주세요. 종이에 쓴 편지는 아래에서 촬영해 첨부하십시오. (책 59쪽)' },
    ],
  },
  step: {
