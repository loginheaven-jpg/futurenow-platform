...
// 책 페이지 참조는 문장 끝 괄호에 좌표로만. '워크북' 은 회차 문안에 쓰지 않는다 — 사진 블록 제목 한 자리만 예외다(`workbook.ts` · ADR-197).
...
export const CHECKIN_SESSION_1 = {
  ...
  deepen: {
    ...
    fields: [
      ...
      { key: 'letter_line', label: '과거의 나에게 편지를 써 보세요.', help: '만약 종이에 이미 썼다면 그 내용 중 가장 해 주고 싶었던 말 한 줄만 옮겨 주세요. (책 59쪽)' },
    ],
  },
  step: {
