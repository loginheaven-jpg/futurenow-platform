...
export const CHECKIN_SESSION_2 = {
  ...
  step: {
    ...
    // ADR-102 축1 — '하나면 충분해요'와 '두 개를 적으면 대개 둘 다 하지 않거든요'를 함께 지운다.
    //   앞엣것은 허락이고 뒤엣것은 그 허락의 이유라, 앞을 지우면 뒤가 가리킬 데가 없어진다.
    //   남는 것은 용어 안내 한 줄 — 이 칸에 필요한 전부다.
    help: "이 세미나에서는 이것을 '한 걸음'이라고 부릅니다.",
