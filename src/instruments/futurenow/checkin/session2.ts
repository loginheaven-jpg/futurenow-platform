...
export const CHECKIN_SESSION_2 = {
  ...
  // 워크북 사진 블록의 안내 한 줄(ADR-197) — 편지 칸에 있던 첨부 안내가 맨 위 사진 자리로 옮겨 왔다.
  //   편지 칸에는 옮겨 적기 안내만 남는다(같은 안내를 두 곳에 두지 않는다).
  workbook: { help: '종이에 쓴 편지도 여기에 촬영해 첨부하십시오.' },
  today: {
  ...
  deepen: {
    ...
    fields: [
      ...
      { key: 'letter_line', label: '미래의 내가 지금의 나에게 보낸 편지를 써 보세요.', help: '만약 종이에 이미 썼다면 그 내용 중 가장 마음에 남는 한 줄만 옮겨 주세요. (책 85~87쪽)' },
    ],
  },
  step: {
