    ...
    fields: [
      {
        ...
        // ADR-98: 삭제하자는 의견은 받지 않았다 — 심화 블록의 유일한 자책 방지 장치이고 실강에서
        //   그 위험이 실제로 발현됐다. 다만 '~이 아닙니다'라는 부정 서술이 약하므로 긍정형으로 바꾼다.
        help: '보인 것 하나면 충분합니다. 오늘은 알아차리는 데까지가 몫이에요.',
        mirror: { label: '지난 시간에 쓰신 문장', keys: ['identity_statement'] },
      },
      {
        key: 'speech_habit',
        label: '요즘 내 입에서 가장 자주 나오는 말 한마디는 무엇인가요? (책 126~133쪽)',
        help: '좋은 말이든 아니든, 그냥 자주 나오는 말이면 됩니다.',
      },
    ],
