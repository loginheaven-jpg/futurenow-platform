...
export const CHECKIN_SESSION_4 = {
  ...
  today: {
    ...
    areaPick: {
      ...
      help: '칸에 적힌 개수와 관계없이, 이번에 먼저 시작할 하나를 고르십시오.',
      ...
      lines: [
        { key: 'project_name', label: '그 프로젝트의 이름', placeholder: '주 한 번씩 현업 선배 만나기' },
        {
          ...
          help: '프로젝트 이름과 마감일을 함께 적어, 결심을 일정으로 바꿉니다.',
          placeholder: '10월 31일',
        },
      ],
    ...
    pairText: {
      ...
      help: '급한 일이나 쉬운 일이 아니라, 그것 하나가 되면 나머지가 쉬워지는 하나를 고르십시오.',
    ...
    question: {
      ...
      help: '지금 버리는 것이 아니라 순서를 뒤로 두는 것입니다. 언제쯤 다시 볼지 정해 두셨다면 함께 적으십시오.',
      badge: '선택',
    },
    ...
    fields: [
      {
        ...
        help: '오늘 세우신 것은 가설입니다. 다음 회차에서 더 선명하게 다듬어 갑니다.',
