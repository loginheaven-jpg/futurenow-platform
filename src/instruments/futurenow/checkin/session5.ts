...
export const CHECKIN_SESSION_5 = {
  ...
  today: {
    ...
    identity: {
      ...
      help: '가까이 두기로 한 것이든 멀리 두기로 한 것이든, 하나만 적으십시오.',
    ...
    question: {
      group: '신호를 만들다',
      key: 'relief',
      label: "의지가 아니라 환경 때문이었구나 싶었던 순간이 오늘 있었다면, 하나만 적어 주세요. (책 202~207쪽)",
      help: '떠오른 그대로 적으십시오.',
      badge: '선택',
    },
  ...
  deepen: {
    ...
    fields: [
      {
        key: 'ask_person',
        label: '이번 주 실행을 함께 봐 줄 한 분께, 무엇을 부탁하시겠어요? (책 216~221쪽)',
        // 앞은 사실 진술, 뒤는 값이다. 실행 동행은 인도자가 배정하므로 카드가 다시 묻지 않고,
        //   대신 **방 밖의 한 사람**을 묻는다 — 세미나가 끝난 뒤에도 남는 것은 이쪽이다.
        help: '부탁할 말을 여기서 먼저 만들어 두면, 직접 꺼낼 때 쉬워집니다.',
      },
      {
        key: 'domino_if',
      ...
      },
      {
        ...
        help: '오늘 모임에서는 가벼운 것으로 연습했습니다. 여기서는 그 신호를 첫 도미노에 겁니다.',
      },
    ],
  },
  step: {
  ...
  wrap: {
    ...
    selfNote: {
      ...
      placeholder: '설계는 끝났다. 오늘 밤부터 옮긴다',
    },
  },
  // save · done 은 회차 공통.
  save: {
