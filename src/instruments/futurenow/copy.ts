...
export const blockIntros: Record<WaveKey, { compass: string; now: string; gap: string; ask: string }> = {
  pre: {
    ...
    gap:
      '내가 원하는 모든 것을 이룬 5년 후의 내 모습을 10점이라 할 때, 지금의 나는 각 영역에서 몇 점입니까?\n그 숫자가 낮다고 실망하지 마세요. 그 간격의 크기가 바로, 당신이 지금 그것을 간절히 바라고 있다는 증거입니다.',
  ...
  post: {
    ...
    gap:
      '5년 후의 완성된 내 모습을 10점이라 할 때, 각 영역에서 지금의 나는 몇 점입니까?\n두 숫자 사이의 거리가, 6주 동안 당신이 실제로 움직인 만큼입니다. 작은 변화라도 그 방향이 중요합니다.',
    ask: '정답이 없는 질문입니다. 6주를 천천히 되감아 보며 적어 주세요.',
  },
};
export const faithIntro =
  '신앙은 사람마다 자리가 다릅니다. 지금의 솔직한 상태를 표시해 주세요. 답하기 어려운 질문은 비워 두어도 괜찮습니다.';
