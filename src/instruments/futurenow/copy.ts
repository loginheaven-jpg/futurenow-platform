...
export const introBlock: Record<WaveKey, { intro: string; placeholder: string }> = {
  pre: {
    intro:
      '시작하기 전에, 잠시 미래의 한 장면을 떠올려 봅니다.\n5년 뒤, 당신은 어떤 사람이 되어 있고 싶습니까?\n그때의 모습, 표정, 그가 건네는 한마디를 떠오르는 대로 적어 주세요.',
    placeholder: '[ 나의 인생 조감도 — 한 문장 스케치 ]',
  },
  post: {
    intro:
      '시작하기 전에, 이 여정을 막 시작하던 6주 전의 당신을 떠올려 봅니다.\n6주 전, 막막함 속에 첫 페이지를 펼쳤던 그 사람에게 지금의 당신은 무슨 말을 건네고 싶습니까?\n그가 가장 듣고 싶어 했을 한마디를 떠오르는 대로 적어 주세요.',
    placeholder: '[ 6주 전의 나에게 — 한마디 ]',
  },
};
...
export const blockIntros: Record<WaveKey, { compass: string; now: string; gap: string; ask: string }> = {
  pre: {
    ...
    gap:
      '내가 원하는 모든 것을 이룬 5년 후의 내 모습을 10점이라 할 때, 지금의 나는 각 영역에서 몇 점입니까?\n숫자는 비교를 위한 점수가 아니라, 어디서부터 움직일지 정하는 기준입니다.',
    ask: '정답이 없는 질문입니다. 떠오르는 대로, 솔직하게 적어 주세요.',
  },
  post: {
    compass: '6주 전과 같은 질문입니다. 그때를 기억하려 말고, 지금의 나에게 더 가까운 쪽으로 점을 표시해 주세요.',
    now: '6주 전과 같은 문장들입니다. 그때의 답은 잊고, 지금 이 순간의 나를 그대로 표시해 주세요.',
    gap:
      '5년 후의 완성된 내 모습을 10점이라 할 때, 각 영역에서 지금의 나는 몇 점입니까?\n사전 기록과 나란히 보며, 여섯 주 동안 달라진 방향을 확인합니다.',
    ask: '정답이 없는 질문입니다. 6주를 천천히 되감아 보며 적어 주세요.',
  },
};
export const faithIntro =
  '신앙은 사람마다 자리가 다릅니다. 지금의 솔직한 상태를 표시해 주세요. 답하지 않기로 한 질문은 비워 두시면 됩니다.';
...
export const askPrompts: Record<WaveKey, { E1: string; E2: string; E3: string }> = {
  ...
  post: {
    E1: "6주 전, 당신은 '이 세미나가 끝나면 무엇이 달라지길' 바랐습니다. 그 바람은 지금 어떻게 되었습니까?",
    E2:
      '6주 동안 당신 안에서 가장 크게 달라진 것 하나를 꼽는다면 무엇입니까?\n아주 작은 변화여도 좋습니다. 그것이 가장 진짜일 때가 많습니다.',
...
export const commitLabel: Record<WaveKey, string> = {
  pre: "나는 이 6주를, '미래의 나'를 만나는 시간으로 끝까지 걸어 보겠습니다.",
  post: "나는 이 6주에서 만난 '미래의 나'를, 오늘 이후의 삶에서 계속 살아내겠습니다.",
};
